...
class Gmaps_Public {
    ...
    public function enqueue_scripts() {
        ...
        wp_enqueue_script($this->plugin_name . '-main-scripts', plugin_dir_url( __DIR__ ) . '/public/js/gmaps' . Gmaps_Helper::maybe_minify_file_extension(".js"), array(), $this->version, true);
